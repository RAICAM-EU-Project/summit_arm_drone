...
def generate_launch_description():
    ...
    moveit_config = (
        MoveItConfigsBuilder("husky_ur5" , package_name="husky_ur5_moveit")
        .robot_description(
            file_path="config/husky_ur5.urdf.xacro",
            # mappings={
        ...
        .robot_description_semantic(file_path="config/husky_ur5.srdf")
